	            ...
	            <div class="container">
	                <div class="row">
	                    <div class="col-md-12 text-center">
                            ...
                            <a href="#SERVICE"><img src="./resources/image/scroll.png" alt=""></a>
	                            <h4>Scroll Down</h4>
	                        </div>
	                    </div>
	                </div>
	            ...
	            <div class="container">
	                <div class="row">
	                    ...
	                    <div class="col-md-5 col-md-offset-1 wow fadeInRight animated">
	                        <div class="imac">
	                            <img src="./resources/image/imac.png" alt="">
	                        </div>
	                    </div>
	                </div>
	            </div>            
    ...
    <section class="work_area" id="WORK">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-4 no_padding">
                    <div class="single_image">
                        <img src="./resources/image/w1.jpg" alt="">
                ...
                <div class="col-md-4 no_padding">
                    <div class="single_image">
                        <img src="./resources/image/w2.jpg" alt="">
                        <div class="image_overlay">
                            <a href="">View Full Project</a>
                            <h2>drawing</h2>
                            <h4>with pencil colors</h4>
                ...
                <div class="col-md-4 no_padding">
                    <div class="single_image">
                        <img src="./resources/image/w3.jpg" alt="">
                        <div class="image_overlay">
                            <a href="">View Full Project</a>
                            <h2>drawing</h2>
                            <h4>with pencil colors</h4>
            ...
            <div class="row pad_top">
                <div class="col-md-4 no_padding">
                    <div class="single_image">
                        <img src="./resources/image/w4.jpg" alt="">
                        <div class="image_overlay">
                            <a href="">View Full Project</a>
                            <h2>drawing</h2>
                            <h4>with pencil colors</h4>
                ...
                <div class="col-md-4 no_padding">
                    <div class="single_image">
                        <img src="./resources/image/w5.jpg" alt="">
                        <div class="image_overlay">
                            <a href="">View Full Project</a>
                            <h2>drawing</h2>
                            <h4>with pencil colors</h4>
                ...
                <div class="col-md-4 no_padding">
                    <div class="single_image last_padding">
                        <img src="./resources/image/w6.jpg" alt="">
                        <div class="image_overlay">
                            <a href="">View Full Project</a>
                            <h2>drawing</h2>
                            <h4>with pencil colors</h4>
