...
INSERT INTO BEDTIME(PT_NO, TODAY, TIMETOSLEEP, TIMETOGETUP, REPORT) VALUES(1, to_date(sysdate, 'yy/mm/dd'), '13:00', '14:30', '낮잠');
INSERT INTO BEDTIME(PT_NO, TODAY, TIMETOSLEEP, TIMETOGETUP, REPORT) VALUES(1, to_date(sysdate, 'yy/mm/dd'), '22:00', '06:30', '겨울잠');
...
INSERT INTO DAILYCLEANING(PT_NO, today, CLEANING, CLEANINGREPORT) VALUES(1, to_date(sysdate, 'yy/mm/dd'), '10:10', '방청소, 욕실청소');
...
INSERT INTO DAILYWASH(PT_NO, today, WASH, WASHREPORT) VALUES(1, to_date(sysdate, 'yy/mm/dd'), '15:28', '속옷, 이불');
...
INSERT INTO DAILYSHOWER(PT_NO, TODAY, SHOWER, SHOWERREPORT) VALUES(1, to_date(sysdate, 'yy/mm/dd'), '21:28', '간단한 족욕');
...
INSERT INTO SPECIAL(PT_NO, REPORTTIME, REPORT) VALUES(1, '14:37', '집에가고싶다하심');
INSERT INTO SPECIAL(PT_NO, REPORTTIME, REPORT) VALUES(1, '20:09', '탈출하고싶다하심');
...
INSERT INTO DR_OP(PT_NO, REPORTTIME, REPORT) VALUES(1, '15:37', '겡끼하심');
INSERT INTO DR_OP(PT_NO, REPORTTIME, REPORT) VALUES(1, '21:09', '감기약 복용하세요');
...
insert into exercise(PT_NO, today, EXERCISETIME, EXERCISETEXT) VALUES(1,TO_DATE(sysdate, 'yy/mm/dd'),TO_DATE('2017-04-04 14:28', 'YYYY/MM/DD HH24:MI'), '줄넘기 3000번');
...
INSERT INTO MEAL(PT_NO, today, TYPEEAT, MEALTIME, WHATEAT) VALUES(1, to_date(sysdate, 'yy/mm/dd'), '아침', '10:10', '콘푸로스트');
INSERT INTO MEAL(PT_NO, today, TYPEEAT, MEALTIME, WHATEAT) VALUES(1, to_date(sysdate, 'yy/mm/dd'), '점심', '14:28', '밥, 김치찌개');
INSERT INTO MEAL(PT_NO, today, TYPEEAT, MEALTIME, WHATEAT) VALUES(1, to_date(sysdate, 'yy/mm/dd'),'저녁', '18:40', '연어초밥');

SELECT * FROM MEAL

SELECT * FROM MEAL WHERE TODAY = TO_DATE('20170404','YYYYMMDD');
